...
/*void B1PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  else *//*if ( fEnvelopeTubs ) {
    //envSizeXY = fEnvelopeTubs->GetOuterRadius();
    //envSizeZ = fEnvelopeTubs->GetZHalfLength()*2;
  }
  else  {
...
void B1PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent) {
    fParticleSource->GeneratePrimaryVertex(anEvent);
    G4double x0 = anEvent->GetPrimaryVertex(0)->GetX0();
    G4double y0 = anEvent->GetPrimaryVertex(0)->GetY0();
    G4double z0 = anEvent->GetPrimaryVertex(0)->GetZ0();
